...
export const DEMO_SERVICES: Service[] = [
  {
    ...
    duration_min: 60,
    price: 280,
    description: 'A gentle, flowing full-body massage designed to relax muscles, relieve tension, and improve circulation.',
    image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: true,
    branch_ids: ['branch-001', 'branch-002', 'branch-003', 'branch-004', 'branch-005'],
  },
  {
    id: 'svc-002',
    ...
    duration_min: 90,
    price: 380,
    description: 'Intense therapeutic pressure targeting chronic muscle tightness, knots, and postural imbalances.',
    image: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: true,
    branch_ids: ['branch-001', 'branch-002', 'branch-003', 'branch-005'],
  },
  {
    id: 'svc-003',
    ...
    duration_min: 75,
    price: 420,
    description: 'Warm basalt stones placed along energy meridians to melt away deep tension and induce calm.',
    ...
    branch_ids: ['branch-001', 'branch-002', 'branch-004'],
  },
  {
    id: 'svc-004',
    ...
    duration_min: 60,
    price: 300,
    description: 'Essential oils blended to your mood for sensory restoration, stress relief, and inner tranquility.',
    image: 'https://images.unsplash.com/photo-1600334129128-685c5582fd35?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: true,
    branch_ids: ['branch-001', 'branch-003', 'branch-004', 'branch-005'],
  },
  {
    id: 'svc-005',
    ...
    duration_min: 60,
    price: 220,
    description: 'Deep infusion of hyaluronic moisture and botanical antioxidants to plump and quench dry skin.',
  ...
  },
  {
    ...
    duration_min: 90,
    price: 350,
    description: 'Advanced peptide therapy and micro-firming massage to lift contours and restore skin elasticity.',
    image: 'https://images.unsplash.com/photo-1512290900672-1f4a43419998?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: true,
  ...
  },
  {
    ...
    duration_min: 75,
    price: 450,
    description: 'Luxurious 24k gold leaf infusion delivering luminous clarity and revitalized complexion.',
    image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: false,
    branch_ids: ['branch-001', 'branch-004', 'branch-005'],
  },
  {
    id: 'svc-008',
    name: 'Moroccan Royal Bath',
    category: 'Body',
    duration_min: 60,
    price: 250,
    description: 'Traditional steam ritual with black soap exfoliation, kessa scrub, and nourishing rhassoul clay.',
  ...
  {
    id: 'svc-009',
    name: 'Body Scrub & Herbal Wrap',
    category: 'Body',
    duration_min: 90,
    price: 320,
    description: 'Mineral-rich sea salt exfoliation followed by a detoxifying herbal thermal cocoon wrap.',
    image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: false,
    branch_ids: ['branch-002', 'branch-003', 'branch-004', 'branch-005'],
  },
  {
    id: 'svc-010',
    ...
    duration_min: 75,
    price: 180,
    description: 'Complete nail shaping, cuticle care, exfoliating scrub, and relaxing hand & foot massage.',
  ...
  },
  {
    ...
    duration_min: 60,
    price: 150,
    description: 'Precision artisan nail design with chip-resistant, high-gloss gel polish cured under LED light.',
  ...
  {
    id: 'svc-012',
    name: 'Herbal Scalp & Hair Treatment',
    category: 'Wellness',
    duration_min: 60,
    price: 240,
    description: 'Ayurvedic botanical oil scalp massage that revitalizes follicles and restores brilliant shine.',
    image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&auto=format&fit=crop&q=80',
    can_do_home_service: true,
    branch_ids: ['branch-001', 'branch-003', 'branch-005'],
  },
];
